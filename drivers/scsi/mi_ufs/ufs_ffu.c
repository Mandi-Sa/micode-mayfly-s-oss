...
#include "ffu/Solvit_V6_256GB_PEB_FW02.h"
#include "ffu/Solvit_V6_128GB_PEB_FW02.h"
#include "ffu/Solvit_UFS_3_1_256GB_P03.h"
#include "ffu/Solvit_UFS_3_1_128GB_P03.h"
#include "ffu/Solvit_UFS_3_1_128GB_FW07.h"
#include "ffu/Solvit_UFS_3_1_256GB_FW07.h"
#include "ffu/Samsung_KLUFG8RHGB_512GB_0401.h"
#include "ffu/Micron_Aquila_B122.h"
#include "ffu/Micron_Aquila_0203.h"
#include "ffu/Hynix_UFS_3_1_A002.h"
#include "ffu/WDC_EU551_1114.h"
#include "ffu/WDC_EU551_1124.h"
#include "ffu/MICRON_Aquila_UFS31_128GB_256GB_FBS_0202.h"
#include "mi-ufshcd.h"
#include "../sd.h"
...
static struct fw_update_checklist need_update_k[] = {
	...
	{"SAMSUNG", "KLUEG8UHGC-B0E1", "0200", "EB02",
	(uint64_t)SAMSUNG_256GB_EB02, sizeof(SAMSUNG_256GB_EB02)},
	{"SAMSUNG", "KLUEG8UHGC-B0E1", "EB02", "0300",
        (uint64_t)SAMSUNG_256GB_0300, sizeof(SAMSUNG_256GB_0300)},
	{"SAMSUNG", "KLUEG8UHGC-B0E1", "0300", "0700",
        (uint64_t)SAMSUNG_256GB_0700, sizeof(SAMSUNG_256GB_0700)},
	{"SAMSUNG", "KLUEG8UHGC-B0E1", "0500", "0700",
        (uint64_t)SAMSUNG_256GB_0700, sizeof(SAMSUNG_256GB_0700)},
	{"SAMSUNG", "KLUDG4UHGC-B0E1", "0200", "EB02",
        (uint64_t)SAMSUNG_128GB_EB02, sizeof(SAMSUNG_128GB_EB02)},
	{"SAMSUNG", "KLUDG4UHGC-B0E1", "EB02", "0300",
        (uint64_t)SAMSUNG_128GB_0300, sizeof(SAMSUNG_128GB_0300)},
	{"SAMSUNG", "KLUDG4UHGC-B0E1", "0300", "0700",
        (uint64_t)SAMSUNG_128GB_0700, sizeof(SAMSUNG_128GB_0700)},
	{"SAMSUNG", "KLUDG4UHGC-B0E1", "0500", "0700",
        (uint64_t)SAMSUNG_128GB_0700, sizeof(SAMSUNG_128GB_0700)},
	{"SAMSUNG", "KLUFG8RHGB-B0E1", "0100", "0401",
        (uint64_t)SAMSUNG_512GB_0401, sizeof(SAMSUNG_512GB_0401)},
	{"MICRON", "MT256GAXAT4U31", "0102", "B122",
        (uint64_t)MICRON_AQUILA_B122, sizeof(MICRON_AQUILA_B122)},
	{"MICRON", "MT256GAXAT4U31", "B122", "0203",
        (uint64_t)MICRON_AQUILA_0203, sizeof(MICRON_AQUILA_0203)},
	{"MICRON", "MT256GAXAT4U31", "0202", "0203",
        (uint64_t)MICRON_AQUILA_0203, sizeof(MICRON_AQUILA_0203)},
	{"SKhynix", "HN8T05DEHKX073", "A001", "A002",
        (uint64_t)HYNIX_128GB_256GB_A002, sizeof(HYNIX_128GB_256GB_A002)},
	{"SKhynix", "HN8T15DEHKX075", "A001", "A002",
        (uint64_t)HYNIX_128GB_256GB_A002, sizeof(HYNIX_128GB_256GB_A002)},
	{"WDC", "SDINFDO4-128G", "0932", "1124",
        (uint64_t)WDC_EU551_1124, sizeof(WDC_EU551_1124)},
	{"WDC", "SDINFDO4-256G", "0932", "1124",
        (uint64_t)WDC_EU551_1124, sizeof(WDC_EU551_1124)},
	{"WDC", "SDINFDO4-512G", "0932", "1124",
        (uint64_t)WDC_EU551_1124, sizeof(WDC_EU551_1124)},
	{"WDC", "SDINFDO4-128G", "1106", "1124",
        (uint64_t)WDC_EU551_1124, sizeof(WDC_EU551_1124)},
	{"WDC", "SDINFDO4-256G", "1106", "1124",
        (uint64_t)WDC_EU551_1124, sizeof(WDC_EU551_1124)},
	{"WDC", "SDINFDO4-512G", "1106", "1124",
        (uint64_t)WDC_EU551_1124, sizeof(WDC_EU551_1124)},
	{"WDC", "SDINFDO4-128G", "1114", "1124",
        (uint64_t)WDC_EU551_1124, sizeof(WDC_EU551_1124)},
	{"WDC", "SDINFDO4-256G", "1114", "1124",
        (uint64_t)WDC_EU551_1124, sizeof(WDC_EU551_1124)},
	{"WDC", "SDINFDO4-512G", "1114", "1124",
        (uint64_t)WDC_EU551_1124, sizeof(WDC_EU551_1124)},
};
