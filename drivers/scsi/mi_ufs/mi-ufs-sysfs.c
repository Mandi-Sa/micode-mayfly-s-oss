...
int  __attribute__((weak)) ufshcd_wb_toggle_flush_during_h8(struct ufs_hba *hba, bool set)
{
	return 0;
}
void __attribute__((weak)) ufshcd_wb_toggle_flush(struct ufs_hba *hba, bool enable)
{
	return;
}
